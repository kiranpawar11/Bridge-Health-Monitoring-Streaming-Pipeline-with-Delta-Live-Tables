# bridge_monitoring_dlt_pipeline

This folder defines all source code for the 'bridge_monitoring_dlt_pipeline' pipeline:
...
* Take a look at the sample under "sample_users_bridge_monitoring_dlt_pipeline.py" to get familiar with the syntax.
